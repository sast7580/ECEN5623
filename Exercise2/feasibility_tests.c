...
// U=1.0, example Butazzo
U32_T ex5_period[] = {4, 8, 12, 16};
U32_T ex5_wcet[] = {1, 2, 3, 4};

// U=1.0, example 9
U32_T ex6_period[] = {6, 8, 12, 24};
U32_T ex6_wcet[] = {1, 2, 4, 6};

// U=1.0, example 3 harmonic
...
{ 
    ...
    printf("Ex-5 U=%4.2f (C1=1, C2=2, C3=3, C4=4; T1=4, T2=8, T3=12, T4=16; T=D): ",
